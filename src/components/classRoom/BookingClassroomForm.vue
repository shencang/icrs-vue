    ...
    <div>
        ...
        <el-dialog
            ...
            <el-form v-model="form" style="text-align: left" ref="dataForm">
                <el-form-item label="活动名称" :label-width="formLabelWidth" prop="roomNum">
                    <el-input v-model="form.roomNum" autocomplete="off" placeholder="获取用参数"></el-input>
                </el-form-item>
                <el-form-item label="参加人数" :label-width="formLabelWidth" prop="roomName">
                    <el-input v-model="form.roomName" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="开始时间" :label-width="formLabelWidth" prop="description">
                    <el-input v-model="form.description" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="结束时间" :label-width="formLabelWidth" prop="status">
                    <el-input v-model="form.status" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="备注" :label-width="formLabelWidth" prop="position">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="onSubmit">立刻预约</el-button>
            </div>
        </el-dialog>
    </div>
</template>
